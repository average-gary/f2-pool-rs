...
pub struct V2HashRateDistributionOrdersPostParams {
    pub f2_p_api_secret: String,
    pub v2_hash_rate_distribution_orders_post_request:
        models::V2HashRateDistributionOrdersPostRequest,
}
...
pub struct V2HashRateDistributionTerminatePostParams {
    pub f2_p_api_secret: String,
    pub v2_hash_rate_distribution_terminate_post_request:
        models::V2HashRateDistributionTerminatePostRequest,
}
...
pub struct V2MiningUserBalanceWithdrawPostParams {
    pub f2_p_api_secret: String,
    pub v2_mining_user_balance_withdraw_post_request:
        models::V2MiningUserBalanceWithdrawPostRequest,
}
...
pub struct V2MiningUserReadOnlyPageAddPostParams {
    pub f2_p_api_secret: String,
    pub v2_mining_user_read_only_page_add_post_request:
        models::V2MiningUserReadOnlyPageAddPostRequest,
}
...
pub struct V2MiningUserReadOnlyPageDeletePostParams {
    pub f2_p_api_secret: String,
    pub v2_mining_user_read_only_page_delete_post_request:
        models::V2MiningUserReadOnlyPageDeletePostRequest,
}
...
pub struct V2MiningUserThresholdUpdatePostParams {
    pub f2_p_api_secret: String,
    pub v2_mining_user_threshold_update_post_request:
        models::V2MiningUserThresholdUpdatePostRequest,
}
...
pub async fn v2_assets_balance_post(
    configuration: &configuration::Configuration,
    params: V2AssetsBalancePostParams,
) -> Result<models::V2AssetsBalancePost200Response, Error<V2AssetsBalancePostError>> {
    ...
    local_var_req_builder =
        local_var_req_builder.header("F2P-API-secret", f2_p_api_secret.to_string());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2AssetsBalancePostError> =
...
pub async fn v2_assets_settle_mode_switch_post(
    configuration: &configuration::Configuration,
    params: V2AssetsSettleModeSwitchPostParams,
) -> Result<models::V2AssetsSettleModeSwitchPost200Response, Error<V2AssetsSettleModeSwitchPostError>>
{
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_assets_settle_mode_switch_post_request =
        params.v2_assets_settle_mode_switch_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/assets/settle_mode/switch",
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2AssetsSettleModeSwitchPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_assets_transactions_list_post(
    configuration: &configuration::Configuration,
    params: V2AssetsTransactionsListPostParams,
) -> Result<models::V2AssetsTransactionsListPost200Response, Error<V2AssetsTransactionsListPostError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2AssetsTransactionsListPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_blocks_date_range_post(
    configuration: &configuration::Configuration,
    params: V2BlocksDateRangePostParams,
) -> Result<models::V2BlocksPagingPost200Response, Error<V2BlocksDateRangePostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2BlocksDateRangePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_blocks_paging_post(
    configuration: &configuration::Configuration,
    params: V2BlocksPagingPostParams,
) -> Result<models::V2BlocksPagingPost200Response, Error<V2BlocksPagingPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2BlocksPagingPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_hash_rate_distribute_post(
    configuration: &configuration::Configuration,
    params: V2HashRateDistributePostParams,
) -> Result<models::HashRateDistributionOrder, Error<V2HashRateDistributePostError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_hash_rate_distribution_info_post_request =
        params.v2_hash_rate_distribution_info_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/hash_rate/distribute",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder =
        local_var_req_builder.header("F2P-API-secret", f2_p_api_secret.to_string());
    local_var_req_builder =
        local_var_req_builder.json(&v2_hash_rate_distribution_info_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2HashRateDistributePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_hash_rate_distribution_info_post(
    configuration: &configuration::Configuration,
    params: V2HashRateDistributionInfoPostParams,
) -> Result<
    models::V2HashRateDistributionInfoPost200Response,
    Error<V2HashRateDistributionInfoPostError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        "{}/v2/hash_rate/distribution/info",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2HashRateDistributionInfoPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_hash_rate_distribution_orders_post(
    configuration: &configuration::Configuration,
    params: V2HashRateDistributionOrdersPostParams,
) -> Result<
    models::V2HashRateDistributionOrdersPost200Response,
    Error<V2HashRateDistributionOrdersPostError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_hash_rate_distribution_orders_post_request =
        params.v2_hash_rate_distribution_orders_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/hash_rate/distribution/orders",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder =
        local_var_req_builder.header("F2P-API-secret", f2_p_api_secret.to_string());
    local_var_req_builder =
        local_var_req_builder.json(&v2_hash_rate_distribution_orders_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2HashRateDistributionOrdersPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_hash_rate_distribution_settlements_post(
    configuration: &configuration::Configuration,
    params: V2HashRateDistributionSettlementsPostParams,
) -> Result<
    models::V2HashRateDistributionSettlementsPost200Response,
    Error<V2HashRateDistributionSettlementsPostError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        "{}/v2/hash_rate/distribution/settlements",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2HashRateDistributionSettlementsPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_hash_rate_distribution_terminate_post(
    configuration: &configuration::Configuration,
    params: V2HashRateDistributionTerminatePostParams,
) -> Result<
    models::V2HashRateDistributionTerminatePost200Response,
    Error<V2HashRateDistributionTerminatePostError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_hash_rate_distribution_terminate_post_request =
        params.v2_hash_rate_distribution_terminate_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/hash_rate/distribution/terminate",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder =
        local_var_req_builder.header("F2P-API-secret", f2_p_api_secret.to_string());
    local_var_req_builder =
        local_var_req_builder.json(&v2_hash_rate_distribution_terminate_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2HashRateDistributionTerminatePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_hash_rate_history_post(
    configuration: &configuration::Configuration,
    params: V2HashRateHistoryPostParams,
) -> Result<models::V2HashRateHistoryPost200Response, Error<V2HashRateHistoryPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2HashRateHistoryPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_hash_rate_info_list_post(
    configuration: &configuration::Configuration,
    params: V2HashRateInfoListPostParams,
) -> Result<models::V2HashRateInfoListPost200Response, Error<V2HashRateInfoListPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2HashRateInfoListPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_hash_rate_info_post(
    configuration: &configuration::Configuration,
    params: V2HashRateInfoPostParams,
) -> Result<models::V2HashRateInfoPost200Response, Error<V2HashRateInfoPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2HashRateInfoPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_hash_rate_worker_history_post(
    configuration: &configuration::Configuration,
    params: V2HashRateWorkerHistoryPostParams,
) -> Result<models::V2HashRateHistoryPost200Response, Error<V2HashRateWorkerHistoryPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2HashRateWorkerHistoryPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_hash_rate_worker_list_post(
    configuration: &configuration::Configuration,
    params: V2HashRateWorkerListPostParams,
) -> Result<models::V2HashRateWorkerListPost200Response, Error<V2HashRateWorkerListPostError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2HashRateWorkerListPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_mining_user_add_post(
    configuration: &configuration::Configuration,
    params: V2MiningUserAddPostParams,
) -> Result<models::V2MiningUserAddPost200Response, Error<V2MiningUserAddPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2MiningUserAddPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_mining_user_balance_withdraw_post(
    configuration: &configuration::Configuration,
    params: V2MiningUserBalanceWithdrawPostParams,
) -> Result<
    models::V2MiningUserBalanceWithdrawPost200Response,
    Error<V2MiningUserBalanceWithdrawPostError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_mining_user_balance_withdraw_post_request =
        params.v2_mining_user_balance_withdraw_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/mining_user/balance/withdraw",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder =
        local_var_req_builder.header("F2P-API-secret", f2_p_api_secret.to_string());
    local_var_req_builder =
        local_var_req_builder.json(&v2_mining_user_balance_withdraw_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2MiningUserBalanceWithdrawPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_mining_user_get_post(
    configuration: &configuration::Configuration,
    params: V2MiningUserGetPostParams,
) -> Result<models::V2MiningUserGetPost200Response, Error<V2MiningUserGetPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2MiningUserGetPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_mining_user_list_post(
    configuration: &configuration::Configuration,
    params: V2MiningUserListPostParams,
) -> Result<models::V2MiningUserListPost200Response, Error<V2MiningUserListPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2MiningUserListPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_mining_user_payment_pause_post(
    configuration: &configuration::Configuration,
    params: V2MiningUserPaymentPausePostParams,
) -> Result<models::V2MiningUserWalletUpdatePost200Response, Error<V2MiningUserPaymentPausePostError>>
{
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_mining_user_payment_pause_post_request =
        params.v2_mining_user_payment_pause_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/mining_user/payment/pause",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2MiningUserPaymentPausePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_mining_user_payment_resume_post(
    configuration: &configuration::Configuration,
    params: V2MiningUserPaymentResumePostParams,
) -> Result<
    models::V2MiningUserWalletUpdatePost200Response,
    Error<V2MiningUserPaymentResumePostError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2MiningUserPaymentResumePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_mining_user_read_only_page_add_post(
    configuration: &configuration::Configuration,
    params: V2MiningUserReadOnlyPageAddPostParams,
) -> Result<
    models::V2MiningUserReadOnlyPageAddPost200Response,
    Error<V2MiningUserReadOnlyPageAddPostError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_mining_user_read_only_page_add_post_request =
        params.v2_mining_user_read_only_page_add_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/mining_user/read_only_page/add",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder =
        local_var_req_builder.header("F2P-API-secret", f2_p_api_secret.to_string());
    local_var_req_builder =
        local_var_req_builder.json(&v2_mining_user_read_only_page_add_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2MiningUserReadOnlyPageAddPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_mining_user_read_only_page_delete_post(
    configuration: &configuration::Configuration,
    params: V2MiningUserReadOnlyPageDeletePostParams,
) -> Result<models::V2MiningUserGetPostRequest, Error<V2MiningUserReadOnlyPageDeletePostError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_mining_user_read_only_page_delete_post_request =
        params.v2_mining_user_read_only_page_delete_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/mining_user/read_only_page/delete",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder =
        local_var_req_builder.header("F2P-API-secret", f2_p_api_secret.to_string());
    local_var_req_builder =
        local_var_req_builder.json(&v2_mining_user_read_only_page_delete_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2MiningUserReadOnlyPageDeletePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_mining_user_threshold_update_post(
    configuration: &configuration::Configuration,
    params: V2MiningUserThresholdUpdatePostParams,
) -> Result<
    models::V2MiningUserThresholdUpdatePost200Response,
    Error<V2MiningUserThresholdUpdatePostError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_mining_user_threshold_update_post_request =
        params.v2_mining_user_threshold_update_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/mining_user/threshold/update",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder =
        local_var_req_builder.header("F2P-API-secret", f2_p_api_secret.to_string());
    local_var_req_builder =
        local_var_req_builder.json(&v2_mining_user_threshold_update_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2MiningUserThresholdUpdatePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_mining_user_wallet_update_post(
    configuration: &configuration::Configuration,
    params: V2MiningUserWalletUpdatePostParams,
) -> Result<models::V2MiningUserWalletUpdatePost200Response, Error<V2MiningUserWalletUpdatePostError>>
{
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_mining_user_wallet_update_post_request =
        params.v2_mining_user_wallet_update_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/mining_user/wallet/update",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2MiningUserWalletUpdatePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_revenue_distribution_add_post(
    configuration: &configuration::Configuration,
    params: V2RevenueDistributionAddPostParams,
) -> Result<models::V2RevenueDistributionAddPost200Response, Error<V2RevenueDistributionAddPostError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2RevenueDistributionAddPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_revenue_distribution_delete_post(
    configuration: &configuration::Configuration,
    params: V2RevenueDistributionDeletePostParams,
) -> Result<
    models::V2HashRateDistributionTerminatePost200Response,
    Error<V2RevenueDistributionDeletePostError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_revenue_distribution_delete_post_request =
        params.v2_revenue_distribution_delete_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/revenue/distribution/delete",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder =
        local_var_req_builder.header("F2P-API-secret", f2_p_api_secret.to_string());
    local_var_req_builder =
        local_var_req_builder.json(&v2_revenue_distribution_delete_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2RevenueDistributionDeletePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v2_revenue_distribution_info_post(
    configuration: &configuration::Configuration,
    params: V2RevenueDistributionInfoPostParams,
) -> Result<
    models::V2RevenueDistributionInfoPost200Response,
    Error<V2RevenueDistributionInfoPostError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let f2_p_api_secret = params.f2_p_api_secret;
    let v2_revenue_distribution_info_post_request =
        params.v2_revenue_distribution_info_post_request;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v2/revenue/distribution/info",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V2RevenueDistributionInfoPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
